...
import (
	pbentity "my-user-grpc-service/app/user/api/pbentity"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x13pbentity/user.proto\"4\n" +
	"\n" +
	"GetListReq\x12\x12\n" +
	...
	"\tGetOneRes\x12\"\n" +
	"\x04User\x18\x01 \x01(\v2\x0e.pbentity.UserR\x04User\"_\n" +
	"\tCreateReq\x12\x1a\n" +
	...
	"\tDeleteRes2\xd9\x01\n" +
	"\x04User\x125\n" +
	"\aGetList\x12\x13.user.v1.GetListReq\x1a\x13.user.v1.GetListRes\"\x00\x122\n" +
	"\x06GetOne\x12\x12.user.v1.GetOneReq\x1a\x12.user.v1.GetOneRes\"\x00\x122\n" +
	"\x06Create\x12\x12.user.v1.CreateReq\x1a\x12.user.v1.CreateRes\"\x00\x122\n" +
	"\x06Delete\x12\x12.user.v1.DeleteReq\x1a\x12.user.v1.DeleteRes\"\x00B\x11Z\x0fapp/user/api/v1b\x06proto3"
...
var file_user_v1_user_proto_goTypes = []any{
	(*GetListReq)(nil),    // 0: user.v1.GetListReq
	(*GetListRes)(nil),    // 1: user.v1.GetListRes
	(*GetOneReq)(nil),     // 2: user.v1.GetOneReq
	(*GetOneRes)(nil),     // 3: user.v1.GetOneRes
	(*CreateReq)(nil),     // 4: user.v1.CreateReq
	(*CreateRes)(nil),     // 5: user.v1.CreateRes
	(*DeleteReq)(nil),     // 6: user.v1.DeleteReq
	(*DeleteRes)(nil),     // 7: user.v1.DeleteRes
	(*pbentity.User)(nil), // 8: pbentity.User
}
var file_user_v1_user_proto_depIdxs = []int32{
	8, // 0: user.v1.GetListRes.Users:type_name -> pbentity.User
	8, // 1: user.v1.GetOneRes.User:type_name -> pbentity.User
	0, // 2: user.v1.User.GetList:input_type -> user.v1.GetListReq
	2, // 3: user.v1.User.GetOne:input_type -> user.v1.GetOneReq
	4, // 4: user.v1.User.Create:input_type -> user.v1.CreateReq
	6, // 5: user.v1.User.Delete:input_type -> user.v1.DeleteReq
	1, // 6: user.v1.User.GetList:output_type -> user.v1.GetListRes
	3, // 7: user.v1.User.GetOne:output_type -> user.v1.GetOneRes
	5, // 8: user.v1.User.Create:output_type -> user.v1.CreateRes
	7, // 9: user.v1.User.Delete:output_type -> user.v1.DeleteRes
