...
import (
	...
	sync "sync"
	unsafe "unsafe"
	pbentity "zfw_proxima/app/user/api/pbentity"
...
type UserRegisterRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" v:"required|min-length:2"` // v:required|min-length:2
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserInfoRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          *pbentity.Users        `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty" v:"required"` // v:required
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_account_v1_account_proto_rawDesc = "" +
	...
	"\bUserInfo\x12\x17.account.v1.UserInfoReq\x1a\x17.account.v1.UserInfoRes\"\x00B%Z#zfw_proxima/app/user/api/account/v1b\x06proto3"
